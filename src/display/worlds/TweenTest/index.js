...
import {myExport,hello as Hello, runit} from '/src/system/libs/modules/a.js';
...
import '/src/system/libs/modules/introjs.js';

namespace `display.worlds` (
    class TweenTest extends w3c.ui.Application {
        constructor(element){
            super(element);
