(async ()=>{ namespace `display.components` (
        ...
        setupCanvasDebug(){
            //setup b2 debug draw
             var debugDraw = new b2DebugDraw();
                ...
                display.worlds.entities.Box2DDemo.prototype.template = function(){
                    return `<template>
	<div style="
    left: 50%;
    top: 50%;
...
`
                ...
                display.worlds.entities.Box2DDemo.prototype.cssStyle = function(){
                    return `
html, body, .HelloDomNode {
    width: 100%;
    height: 100%;
    margin: 0;
    padding: 0;
...
`
                ...
                display.worlds.entities.Box2DDemo.prototype.onLoadInstanceStylesheet = function(){ return false }
