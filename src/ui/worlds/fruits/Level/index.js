...
//mport! 'ui.worlds.aeiou.Challenge';
//mport! 'ui.worlds.aeiou.DamageMeter';
...
namespace `ui.worlds.fruits` (
    ...
    class Level extends WebComponent {
        constructor(world, machine) {
            ...
            // this.actions = new ui.worlds.aeiou.Machine;
            this.world=world;
        ...
        async onConnected() {
            ...
            // this.actions.push(new ui.worlds.aeiou.Challenge(this.world, this, this.machine));
            // this.actions.push(new ui.worlds.aeiou.ScoreKeeper(this.world, this.machine));
            // this.actions.push(new ui.worlds.aeiou.DamageMeter(this.world, this.machine));
        }
        ...
        //         doit && this.actions.push(new ui.worlds.aeiou.Challenge(this.world, this, this.machine));
        // }

        // onPauseMenu(){
        //     // this.machine.push(new ui.worlds.aeiou.Menu(this.world, this.machine));
