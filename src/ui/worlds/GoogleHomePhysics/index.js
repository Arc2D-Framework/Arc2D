...
import '@ui.worlds.entities.html.Box2DEntity';
import 'ui.worlds.entities.html.GroundBox';
import 'ui.worlds.entities.html.PolygonShape';
import 'ui.worlds.entities.svg.CircleShape';
...
namespace `ui.worlds` (
    class GoogleHomePhysics extends World {
        ...
        async onConnected() {
            ...
            for(var i = 0; i < 3; ++i) {
                ...
                poly.on("connected", e=> console.log(e.data.target.body))
                //add it to list
                this.nodes.push(poly);
                //add it to stage
                this.stage.appendChild(poly);

                // poly.body.setType(b2Body.b2_dynamicBody);
             }
