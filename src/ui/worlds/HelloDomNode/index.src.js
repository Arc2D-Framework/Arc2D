...
namespace `ui.worlds.entities.html` (
...
namespace `ui.worlds.entities.html` (
	class GroundBox extends ui.worlds.entities.html.Box2DEntity {
        constructor(hWidth,hHeight,world,stage,scale,element){
            super(element);
            this.hw     =hWidth;
            this.hh     =hHeight;
		...
		async onConnected(){
            ...
            var fixDef = new b2FixtureDef;
             ...
             this.style.height= (hh*2)* (this.scale)+"px";
                ...
                ui.worlds.entities.html.GroundBox.prototype.template = function(){
                    return `<template>
	<div>DIV</div>
</template>
`
                ...
                ui.worlds.entities.html.GroundBox.prototype.cssStyle = function(){
                    return `.GroundBox {
	background:#1ac6ff;
    /*display:none;*/
}
`
                ...
                ui.worlds.entities.html.GroundBox.prototype.onLoadInstanceStylesheet = function(){ return false }
...
namespace `ui.worlds.entities.html` (
    class PolygonShape extends ui.worlds.entities.html.Box2DEntity {
        // constructor(hWidth,hHeight,world,stage,scale,element){
        //     super(element);
        //     this.hw     =hWidth;
        //     this.hh     =hHeight;
        ...
        onDraw(){
            ...
            // this.style.height= (hh*2)* (this.scale)+"px";
                ...
                ui.worlds.entities.html.PolygonShape.prototype.template = function(){
                    return `<template>
    <div>DIV</div>
</template>
`
...
//                 ui.worlds.entities.html.PolygonShape.prototype.cssStyle = function(){
//                     return `.PolygonShape {
//     background:#a5e002;
//     /*display:none;*/
//     transform-origin: center;
...
//                 };
                ...
                ui.worlds.entities.html.PolygonShape.prototype.onLoadInstanceStylesheet = function(){ return false }




                
namespace `ui.worlds.entities.svg` (
    class CircleShape extends WebComponent {
        ...
        onDraw(){
            ...
            // this.style.height= (hh*2)* (this.scale)+"px";
                ...
                ui.worlds.entities.svg.CircleShape.prototype.template = function(){
                    return `<template>
...
`
                ...
                ui.worlds.entities.svg.CircleShape.prototype.cssStyle = function(){
                    return `.CircleShape {
    background:#a5e002;
    /*display:none;*/
    transform-origin: center;
...
`
                ...
                ui.worlds.entities.svg.CircleShape.prototype.onLoadInstanceStylesheet = function(){ return false }
...
namespace `ui.worlds` (
    class HelloDomNode extends World {
        ...
        async onConnected() {
            ...
            var ground = new ui.worlds.entities.html.GroundBox(
                12, 
                1, 
                this.world, 
                this.stage, 
            ...
            for(var i = 0; i < 10; ++i) {
             ...
             for(var i = 0; i < 10; ++i) {
                var circle = new ui.worlds.entities.svg.CircleShape(
                    Math.random() + 0.5,
                    this.world,
                    this.svg,
                    this.scale
