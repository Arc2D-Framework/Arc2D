import '/src/libs/game/b2w/Box2D.js';
import! 'applications.box2d.entities.html.Box2DEntity';
import 'applications.box2d.entities.html.GroundBox';
import 'applications.box2d.entities.html.PolygonShape';
import 'applications.box2d.entities.svg.CircleShape';
import '/src/libs/MathUUID.js';
...
namespace `applications.box2d` (
    class HelloDomNode extends World {
        ...
        async onConnected() {
            ...
            var ground = new applications.box2d.entities.html.GroundBox(
                12,1,world,this.stage,this.scale
            );
            this.stage.appendChild(ground)
                
             for(var i = 0; i < 10; ++i) {
                var poly = new applications.box2d.entities.html.PolygonShape(
                    Math.random() + 0.5,
                    Math.random() + 0.5,
                    world,
                    this.stage,
             ...
             for(var i = 0; i < 10; ++i) {
                var circle = new applications.box2d.entities.svg.CircleShape(
