  ...
  <div>
    ...
    <div style="display: flex;flex-direction: row;flex-wrap: nowrap;">
      <div style="width: 50%;padding: 22px;">
        ...
        <p>
          <em>Arc is in incubation as a private repository on github. <b>You'll need to be added as a collaborator</b> in order to fork/install. Reach out to jaysmith024@gmail.com for access.</em>
        </p>
        <p>
          Arc is an SDK for building customized framework architectures and apps. You'll want to
