...
namespace `docs.components` (
    class ProjectExplorer extends docs.components.ExplorerPanel {
        ...
        async onConnected() {
            var ft = await (await fetch("docs/components/ProjectExplorer/data/filetree.json")).json();
            this.filetree =ft;
        ...
        async reset(){
            this.filetree = await (await fetch("docs/components/ProjectExplorer/data/filetree.json")).json();
        }
