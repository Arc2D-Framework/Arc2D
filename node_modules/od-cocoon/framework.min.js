...
next)=>acc[next]?acc[next]:acc[next]={},env);scope[classname]=def;return scope[classname]};var createClass=function(func){try{var proto=func.prototype;proto.ancestor=proto.__proto__.constructor;try{func.define(proto)}catch(e){}return func}catch(e){return func}return func}})(typeof global!="undefined"?global:window);
